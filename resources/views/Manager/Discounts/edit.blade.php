...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="edit-form" method="POST" action="{{ route('manager.discounts.update', $discount->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="percent" value="{{ old('percent', $discount->percent) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="expiration_date" value="{{ old('expiration_date', $discount->expiration_date) }}"
