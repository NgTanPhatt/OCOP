...
<div class="row">
    <div class="col-12">
        <div class="content-header">
            <h2 class="content-title">Tạo Người Dùng</h2>
            <div>
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="create-form" method="POST" action="{{ route('manager.users.store') }}">
                    @csrf

                    <div class="mb-4">
                        <label class="form-label">Họ Tên</label>
                        <input type="text" name="fullname" value="{{ old('fullname') }}" class="form-control @error('fullname') is-invalid @enderror" placeholder="Nhập họ tên">
                        @error('fullname')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" class="form-control @error('username') is-invalid @enderror" placeholder="Nhập tên đăng nhập">
                        @error('username')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4" id="branch-select" style="display: none;">
...
<script>
    ...
    // Mặc định hiển thị/ẩn nếu có giá trị trong old('role')
