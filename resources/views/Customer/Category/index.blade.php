    ...
    <div class="page-header breadcrumb-wrap" style="border-bottom: unset;">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> Danh Mục <span></span> {{ $category->name }}
            </div>
        </div>
    </div>
    @php
    ...
    <div class="container mb-30">
        <div class="row flex-row-reverse">
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>Hiện có <strong class="text-brand">{{ $products->count() }}</strong> sản phẩm cùng danh mục!</p>
                    </div>
                    <form method="GET" action="{{ route('customer.categories.index', $category->id) }}">
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                ...
                @endphp
                <form method="GET" action="{{ route('customer.categories.index', $category_id) }}">
